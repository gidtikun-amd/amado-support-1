...
<body>
    <div class="row mb-3 mt-2">
        ...
        <div class="col-4 ml-5 mt-2">
            ...
            <p class="m-0">
                <span>วันที่</span>
                <span class="bottom-dotted-160 text-center">{{ date('d/m/Y',strtotime($jobreq_date)) }}</span>
            </p>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-4">
            <p class="m-0">
                ...
                @endif
                <label class="ml-2">สร้างผู้ใช้งาน</label>
            </p>
        </div>
        <div class="col-4">
            <p class="m-0">
                ...
                <i class="far fa-square"></i>
                @endif
                <label class="ml-2">แก้ไขผู้ใช้งาน</label>
            </p>
        </div>
        <div class="col-4">
            <p class="m-0">
                ...
                <i class="far fa-square"></i>
                @endif
                <label class="ml-2">ลบผู้ใช้งาน</label>
            </p>
        </div>
    </div>
    <div class="row">
        <div class="col-4">
            <p class="m-0">
                ...
                <i class="far fa-square"></i>
                @endif
                <label class="ml-2">พัฒนาใหม่</label>
            </p>
        </div>
        <div class="col-4">
            <p class="m-0">
        ...
        <div class="col-4">
            <p class="m-0">
                ...
                <i class="far fa-square"></i>
                @endif
                <label class="ml-2">สร้างอีเมลใหม่</label>
            </p>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row mt-2">
        <div class="col-12">
            <p class="m-0">
                <label>รายการที่ร้องขอ ดังนี้</label>
            </p>
        </div>
    </div>    
    @php 
    ...
    <div class="row mt-5">
        <div class="col-6">
            ...
            <p class="m-0 text-center"><span class="mr-2">วันที่ {{ date('d/m/Y',strtotime($jobreq_date)) }}</span></p>
        </div>
        <div class="col-6">
    ...
    <span class="br-fixed text-right">AMD-IT-009 RV.1</span>
</body>
</html>
