...
<body>
    <div class="row mb-3 mt-2">
        ...
        <div class="col-4 ml-5 mt-2">
            <p class="m-0">
                ...
                <span class="bottom-dotted-120 text-center" style="font-size:0.95rem;">{{ $itmreq_no }}</span>
            </p>
            <p class="m-0">
                <span>วันที่</span>
                <span class="bottom-dotted-160 text-center">{{date('d/m/Y',strtotime($itmreq_date))}}</span>
            </p>
        </div>
    </div>
    <div class="row">
        <div class="col-8">
            ...
            <div class="bottom-dotted-400">
                <span class="ml-4">{{ $emp_fullname }}</span>
            </div>
        </div>
        <div class="col-4">
            <span>แผนก</span>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="bottom-dotted-565">
                <span class="ml-4">{{ $itmreq_obj }}</span>
            </div>
        </div>
    </div>
    @php
    ...
    <div class="row mt-5">
        <div class="col-6">
            ...
            <p class="m-0 text-center"><span class="mr-2">( {{ $emp_fullname }} )</span></p>
            <p class="m-0 text-center"><span class="mr-2">วันที่ {{ date('d/m/Y',strtotime($itmreq_date)) }}</span></p>
        </div>
        <div class="col-6">
