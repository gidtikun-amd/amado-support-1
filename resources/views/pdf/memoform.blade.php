...
<body>
    <div class="row mb-3 mt-2">
        ...
        <div class="col-4 text-center">
            <p class="m-0"><b>MEMO</b></p>
            <p class="m-0"><b>AMADO GROUP</b></p>
        </div>
        <div class="col-4 ml-5 mt-2">
            <p class="m-0">
                <span>เลขที่เอกสาร</span>
                <span class="bottom-dotted-120 text-center" style="font-size:1rem;">{{$no}}</span>
            </p>
            <p class="m-0">
                <span>วันที่</span>
                <span class="bottom-dotted-160 text-center">{{date('d/m/Y',strtotime($date))}}</span>
            </p>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="bottom-dotted-620">
                <span class="ml-4">{{$fullnameEn}}</span>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row mt-2">
        <div class="col-12">
            <p class="m-0">
                <p class="m-0">
                    <label class="mr-2">จึงเรียนมาเพื่อขออนุมัต</label>
                </p>
            </p>
        </div>
    </div>
    <div class="row mt-5">
        <div class="col-6">
            ...
            <p class="m-0 text-center"><span class="mr-2">วันที่ {{ date('d/m/Y',strtotime($date)) }}</span></p>
        </div>
        <div class="col-6">
    ...
    <div class="row pt-2">
        <div class="col-12"><span>เฉพาะเจ้าหน้าที่ไอที</span></div>
    </div>
    <div class="row">
        <div class="col-1"></div>
        <div class="col-2">
            <i class="far fa-square mr-2"></i><span>อนุมัติ</span>
        </div>
        <div class="col-2">
            <i class="far fa-square mr-2"></i><span>ไม่อนุมัติ</span>
        </div>
        <div class="col-7"></div>
    </div>
    <div class="row pt-5">
        <div class="col-6">
            <p class="m-0 text-center"><span class="mr-2">ลงชื่อ.....................................................................เจ้าหน้าที่ไอที</span></p>
            <p class="m-0 text-center"><span class="mr-2">(.....................................................................)</span></p>
            <p class="m-0 text-center"><span class="mr-2">วันที่ ......./......./..............</span></p>
        </div>
        <div class="col-6">
