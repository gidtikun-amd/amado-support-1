                            ...
                            <div class="row">
                                <div class="col-md-12 mt-3">
                                    <div class="form-row">
                                        ...
                                        <div class="col-auto" v-show="jbr.nowList != 'wait'">
                                            <label>กรองรายการ</label>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="checkView"
                                                   v-model="tab.searchView"
                                                   v-on:keyup.enter="getDataPaginate('first')"
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body mx-4 mt-5">
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" id="opt_4" name="optobj" value="" disabled
                                                v-if="jbr.detail.jbr_obj==4" :checked="true"
                                            >
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" id="opt_5" name="optobj" value="" disabled
                                                v-if="jbr.detail.jbr_obj==5" :checked="true"
                                            >
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" id="opt_6" name="optobj" value="" disabled
                                                v-if="jbr.detail.jbr_obj==6" :checked="true"
                                            >
                                    ...
                                    <div class="col-md-12 mb-2">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" id="opt_7" name="optobj" value="" disabled
                                                v-if="jbr.detail.jbr_obj==7" :checked="true"
                                            >
                        ...
                        >
                            <h5 class="col-md-auto mb-0 my-auto text-center">เปลี่ยนสถานะ <i class="fas fa-arrow-right ml-2"></i></h5>
                            ...
                            <button v-if="jbr.detail.jbr_status == 2" type="button" class="col-md-3 btn btn-success mr-3"
                                ...
                                v-html="jbr.detail.action.btnSaveTxt"
                            >
                                <i class="fas fa-check text-white mr-2"></i>ดำเนินการเรียบร้อย
                            </button>
                            ...
                            >
                                <i class="fas fa-ban text-white mr-2"></i> ยกเลิก
                            </button>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <ul class="list-group">                                        
                                        ...
                                        v-show="jbr.detail.jbr_file.length <= 0">ไม่มีไฟล์แนบ</li>
                                    </ul>
                                    <ul class="list-group">
                                        <li class="list-group-item py-1"
                                            v-for="(list,index) in jbr.detail.jbr_file" :key="index"
                                        >
            ...
            jbr: {
                ...
                detail: {
                    ...
                    action:{
                        ...
                        btnVoieTxt: '<i class="fas fa-ban text-white mr-2"></i> ยกเลิก',
    ...
    methods:{
        ...
        uploadJobreqFile(e){
            ...
            .then(response => {
                ...
                else if(response.data.error == 'login.fail')
                    this.neviLogin();
        ...
        getDatajbrDetail(jbrId, savestatus){
            ...
            .then(response => {
                ...
                this.jbr.detail.jbr_file = resFiles;
                ...
                if( this.jbr.detail.jbr_status == 1 )
                    this.jbr.detail.action.btnSaveTxt = '<div class="spinner-border spinner-border-sm text-dark mr-2"></div> กำลังดำเนินการ';
                else if( this.jbr.detail.jbr_status == 2 )
                    this.jbr.detail.action.btnSaveTxt = '<i class="fas fa-check text-white mr-2"></i> ดำเนินการเรียบร้อย';

                if (savestatus == true)
                    switch(this.jbr.detail.jbr_status) {
                        case 0: this.$swal({
                            icon: 'error',
                            ...
                            footer: 'เลขที่เอกสาร : '+this.jbr.detail.jbr_no
                        }); break;
                        case 2: this.$swal({
                            icon: 'success',
                            title: '<p class="m-0">เปลี่ยนสถานะเรียบร้อย</p>',
        ...
        getDataJbrFirst(list){
            ...
            if(list == 'wait')
                this.tab.searchView = false;

            axios.post('/api/admin/it/jobrequest/list',{
                filter: this.jbr.nowList,
                search: this.tab.searchTxt,
                searchEmp: this.tab.searchName,
                searchObj: this.tab.searchObj,
                searchPstatus: this.tab.searchPaper,
                searchView: this.tab.searchView,
        ...
        updateJbrStatus(jbrSts){
            ...
            this.$swal({
                ...
                if (result.isConfirmed) {
                    ...
                    axios.post('/api/admin/it/jobrequest/udstatus',{
                        ...
                        if(response.data.status){
                            ...
                            if( jbrSts != 0 ) this.jbr.detail.action.btnSaveTxt = '<i class="fas fa-check text-white mr-2"></i> ดำเนินการเรียบร้อย';
                            else this.jbr.detail.action.btnVoieTxt = '<i class="fas fa-ban text-white mr-2"></i> ยกเลิก';
                        }
                        else{
                            if( jbrSts == 2 )
                                this.jbr.detail.action.btnSaveTxt = '<div class="spinner-border spinner-border-sm text-dark mr-2"></div>กำลังดำเนินการ';
                                ...
                                this.jbr.detail.action.btnVoieTxt = '<i class="fas fa-ban text-white mr-2"></i> ยกเลิก';
                        }
                        ...
                        if(response.data.status){
                            ...
                            this.getDataPaginate(this.paginate.currentPage);
                            this.getDatajbrDetail(this.jbr.detail.jbr_id, true);
                        }
                        else if(response.data.error == 'login.fail')
                            this.neviLogin();
        ...
        updateJbrRemark(){
            ...
            axios.post('/api/admin/it/jobrequest/update/remark',{
                id: this.jbr.detail.jbr_id,
            ...
            .then(response => {
                ...
                if(response.data.status){
                    ...
                    if(response.data.error == 'login.fail') this.neviLogin();
                    else this.$swal({ icon: 'error', title: 'ไม่สามารถบันทึกหมายเหตุได้' });
                }
