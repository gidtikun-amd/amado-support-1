    ...
    <div>
        ...
        <div class="card mb-3">
            <div class="card-header">
                <i class="fas fa-search"></i><span class="ml-2">ค้นหารายงานทรัพย์สิน</span>
            </div>
            <div class="card-body">
                <form :action="'/api/report/it/asset/export'" :method="'post'" :target="'_blank'">
                    <div class="row mb-3">
                        <div class="col-auto">
                        ...
                        <div class="col-auto">
                            <label class="mt-2 ml-2">สถานะ</label>
                        </div>
                        <div class="col-xl-2">
                            <select name="emp_status" class="custom-select">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-xl">
                            ...
                            >
                                <option value="" selected>ทั้งหมด</option>
                                <option v-for="type in assettype" :key="type.it_hw_type_id" :value="type.it_hw_type_id">
                                    {{type.it_hw_type_name}}
                                </option>
                            </select>
                        </div>
                        <div class="col-auto">
