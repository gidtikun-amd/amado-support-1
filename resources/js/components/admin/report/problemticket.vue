    ...
    <div>
        ...
        <div class="card mb-3">
            <div class="card-header">
                <i class="fas fa-search"></i><span class="ml-2">รายงานสรุปปัญหาที่เกิดขึ้น</span>
            </div>
            <div class="card-body">
...
export default {
    ...
    methods: {
        setReport(){
            ...
            let link = '/pdf/report/ticket/'+this.DateDefault;
        ...
        exportWord(){
            ...
            let link = '/word/report/ticket?month='+this.DateDefault;
            window.open(link,'_blank');
        }
    }
}
