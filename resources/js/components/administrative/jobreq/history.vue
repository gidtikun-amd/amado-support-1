                        ...
                        <div class="row justify-content-center pb-3">
                            <div class="col-md-4">
                                <a type="button" class="btn btn-primary w-100"
                                    :href="'/pdf/ad/job-req/'+detail.jbr_id" :target="'_blank'"
...
export default {
    ...
    methods:{
        getHistory(){
            axios.post('/api/ad/job-req/history/list',{
        ...
        searchHistory(){
            axios.post('/api/ad/job-req/search/search',{
        ...
        getDatajbrDetail(jobreqId){
            axios.get('/api/ad/job-req/detail/'+jobreqId)
            .then(response => {
